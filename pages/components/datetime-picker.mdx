...
This component was created due to the bugy nature of the shadcn compoent

```jsx copy
'use client';
import React, { useState } from 'react';
import { DateTimePicker } from '@/your-path';
...
### Preview
import { DateTimePicker } from "@/components/lib/datetime-picker"
